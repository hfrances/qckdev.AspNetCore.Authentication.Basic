...
To display and use Basic authentication in Swagger UI, add a Basic security definition and requirement:
...
Then enable Swagger middleware:
...
And protect endpoints with the Basic scheme:
